export default async function Home() {
  ...
  return (
    <div className="m-4 flex-auto p-4 text-center overflow-hidden text-wrap flex flex-col justify-center items-center">
      <div className="text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r to-indigo-600 from-orange-600 ">HI THERE, VISITOR</div>
